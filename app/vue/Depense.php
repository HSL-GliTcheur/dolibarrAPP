    ...
    <table style="width:100%; border-collapse: collapse; margin-top: 20px;">
        ...
        <tbody>
            <?php foreach ($depenses as $d): ?>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $d['ref']; ?></td>
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $d['description'] ?? 'Pas de description'; ?></td>
